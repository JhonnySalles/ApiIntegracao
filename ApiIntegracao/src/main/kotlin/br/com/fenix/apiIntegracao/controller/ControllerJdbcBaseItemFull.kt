...
abstract class ControllerJdbcBaseItemFull<ID, E : EntityBase<ID, E>, D : DtoBase<ID>, C : ControllerJdbcBaseItemFull<ID, E, D, C>>(repository: RepositoryJdbcItemFull<E, ID>, factory: EntityFactory<ID, E>) {
