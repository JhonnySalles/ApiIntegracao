...
class LegendaController(registry: DynamicJdbcRegistry) : ControllerJdbcBaseTabela<UUID?, Legenda, LegendaDto, LegendaController>(DeckSubtitleRepository(registry)) {
