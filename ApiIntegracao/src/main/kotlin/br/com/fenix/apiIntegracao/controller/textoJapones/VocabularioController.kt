...
class VocabularioController(repository: VocabularioRepository, assembler: PagedResourcesAssembler<VocabularioDto>) : Controller<UUID?, FilaSql, VocabularioDto, VocabularioController>(repository, assembler) {
