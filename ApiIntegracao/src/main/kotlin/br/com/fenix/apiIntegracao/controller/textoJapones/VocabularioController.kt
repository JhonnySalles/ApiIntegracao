...
class VocabularioController(repository: VocabularioRepository) : Controller<UUID?, FilaSql, VocabularioDto>(repository, FilaSql::class.java, VocabularioDto::class.java) {
