...
class EstatisticaController(repository: EstatisticaRepository, assembler: PagedResourcesAssembler<EstatisticaDto>) : ControllerJpaBase<UUID?, Estatistica, EstatisticaDto, EstatisticaController>(repository, assembler) {
