...
class ExclusaoController(repository: ExclusaoRepository, assembler: PagedResourcesAssembler<ExclusaoDto>) : ControllerJpaBase<UUID?, Exclusao, ExclusaoDto, ExclusaoController>(repository, assembler) {
