package br.com.fenix.apiIntegracao.messages;
...
public class Mensagens {
	...
	public final static String BD_ERRO_CREATE_TRIGGERS = "Erro ao criar a trigger.";

	public final static String BD_ERRO_UPDATE_CANCEL = "Erro ao cancelar os registros processados.";
