...
class ValidoController(private val registry: DynamicJpaRepositoryRegistry) : ControllerJpaBase<UUID?, ValidoIngles, ValidoDto, ValidoController, ValidoInglesRepository>() {
