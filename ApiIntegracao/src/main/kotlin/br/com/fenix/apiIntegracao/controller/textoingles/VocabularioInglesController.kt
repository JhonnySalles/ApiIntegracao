...
class VocabularioInglesController(private val registry: DynamicJpaRepositoryRegistry) : ControllerJpaBase<UUID?, VocabularioIngles, VocabularioDto, VocabularioInglesController, VocabularioInglesRepository>() {
