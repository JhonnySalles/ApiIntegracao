...
@Tag(name = "Revisar Inglês", description = "Endpoint de vocabulários para revisão inglês")
class RevisarInglesController(private val registry: DynamicJpaRepositoryRegistry) : ControllerJpaBase<UUID?, RevisarIngles, RevisarDto, RevisarInglesController, RevisarInglesRepository>() {
