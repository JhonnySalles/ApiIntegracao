...
class MangaExtractorController(registry: DynamicJdbcRegistry) : ControllerJdbcBaseTabela<UUID?, Legenda, LegendaDto, MangaExtractorController>(MangaExtractorRepository(registry)) {
